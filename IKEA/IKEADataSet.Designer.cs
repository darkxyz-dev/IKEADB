...
namespace IKEA {
    ...
    public partial class IKEADataSet : global::System.Data.DataSet {
        ...
        public partial class SeriesDataTable : global::System.Data.TypedTableBase<SeriesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SeriesRow AddSeriesRow(string SeriesName, RoomRow parentRoomRowByRoomIdFK) {
                ...
                if ((parentRoomRowByRoomIdFK != null)) {
                    columnValuesArray[2] = parentRoomRowByRoomIdFK[0];
                }
...
namespace IKEA.IKEADataSetTableAdapters {
    ...
    public partial class RoomTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::IKEA.Properties.Settings.Default.IKEAConnectionString;
        }
    ...
    public partial class SeriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Series] WHERE (([Id] = @Original_Id) AND ([SeriesName] = @Orig" +
                "inal_SeriesName) AND ([RoomId] = @Original_RoomId))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Series] ([SeriesName], [RoomId]) VALUES (@SeriesName, @RoomId)" +
                ";\r\nSELECT Id, SeriesName, RoomId FROM Series WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Series] SET [SeriesName] = @SeriesName, [RoomId] = @RoomId WHERE ((" +
                "[Id] = @Original_Id) AND ([SeriesName] = @Original_SeriesName) AND ([RoomId] = @" +
                "Original_RoomId));\r\nSELECT Id, SeriesName, RoomId FROM Series WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, SeriesName, RoomId FROM dbo.Series";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_SeriesName, int Original_RoomId) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_SeriesName == null)) {
                throw new global::System.ArgumentNullException("Original_SeriesName");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_SeriesName));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string SeriesName, int RoomId) {
            if ((SeriesName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string SeriesName, int RoomId, int Original_Id, string Original_SeriesName, int Original_RoomId, int Id) {
            if ((SeriesName == null)) {
                throw new global::System.ArgumentNullException("SeriesName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string SeriesName, int RoomId, int Original_Id, string Original_SeriesName, int Original_RoomId) {
            return this.Update(SeriesName, RoomId, Original_Id, Original_SeriesName, Original_RoomId, Original_Id);
        }
    }
